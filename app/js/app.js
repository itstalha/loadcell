...
(function (window, document, $, undefined) {
    ...
    $(function () {
        ...
        var today_time = new Date().toISOString().split('T')[1];
        today_time.replace('Z', '');
        $('#live_date').text(today_date);
        $('#live_time').text(today_time);
